      ...
      <div className="container px-4 py-12 md:py-16">
        <div className="grid gap-8 md:grid-cols-4">
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-0.5 text-xl font-bold" aria-label="Trang chủ BIBLE LEXICON">
              <Logo className="h-6 w-6" />
              <span className="font-brand font-extrabold uppercase tracking-[0.12em] text-primary dark:text-white">BIBLE LEXICON</span>
            </Link>
          ...
          <nav aria-label="Nguồn dữ liệu">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Bible Lexicon là một sáng kiến phần mềm nguồn mở. Mọi đóng góp về mã nguồn, dữ liệu hay tài chính đều giúp dự án ngày một vững mạnh.
              </p>
              <p className="text-sm text-muted-foreground">
        ...
        <div className="mt-12 pt-8 border-t text-center text-sm text-muted-foreground">
          <p>© <CopyrightYear /> Bible Lexicon. Phát hành dưới giấy phép MIT.</p>
        </div>
      </div>
    </footer>
  )
