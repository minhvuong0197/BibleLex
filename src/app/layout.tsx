...
export const metadata: Metadata = {
  ...
  title: {
    default: "Logos — Tra cứu chỉ mục Strongs và khảo cứu Kinh Thánh nguyên ngữ Hê-bơ-rơ, Hy-lạp",
    template: "%s | Logos",
  },
  ...
  authors: [{ name: "Logos Contributors" }],
  creator: "Logos",
  publisher: "Logos",
  robots: "index, follow",
  openGraph: {
    ...
    locale: "vi_VN",
    siteName: "Logos",
    title: "Logos — Tra cứu Kinh Thánh nguyên ngữ Hê-bơ-rơ, Hy-lạp",
