...
export const metadata: Metadata = {
  ...
  title: {
    default: "Logos Lex — Tra cứu chỉ mục Strongs và khảo cứu Kinh Thánh nguyên ngữ Hê-bơ-rơ, Hy-lạp",
    template: "%s | Logos Lex",
  },
  ...
  authors: [{ name: "Logos Lex Contributors" }],
  creator: "Logos Lex",
  publisher: "Logos Lex",
  robots: "index, follow",
  openGraph: {
    ...
    locale: "vi_VN",
    siteName: "Logos Lex",
    title: "Logos Lex — Tra cứu Kinh Thánh nguyên ngữ Hê-bơ-rơ, Hy-lạp",
