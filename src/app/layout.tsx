...
export const metadata: Metadata = {
  ...
  title: {
    default: "Bible Lexicon — Tra cứu chỉ mục Strongs và khảo cứu Kinh Thánh nguyên ngữ Hê-bơ-rơ, Hy-lạp",
    template: "%s | Bible Lexicon",
  },
  ...
  authors: [{ name: "Bible Lexicon Contributors" }],
  creator: "Bible Lexicon",
  publisher: "Bible Lexicon",
  robots: "index, follow",
  openGraph: {
    type: "website",
    locale: "vi_VN",
    siteName: "Bible Lexicon",
    title: "Bible Lexicon — Tra cứu Kinh Thánh nguyên ngữ Hê-bơ-rơ, Hy-lạp",
