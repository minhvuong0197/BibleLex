        ...
        <div className="container px-4">
          <div className="mx-auto max-w-4xl text-center">
            <div className="flex items-center justify-center gap-0.5 mb-6">
              ...
              <span className="font-brand text-4xl font-extrabold uppercase tracking-[0.15em] text-primary dark:text-white sm:text-5xl">LOGOS</span>
            </div>
      ...
      <section className="py-16 md:py-24 border-y">
        <div className="container px-4">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-2xl mx-auto">
              Logos tổng hợp từ các từ điển và cơ sở dữ liệu học thuật công cộng
            </p>
          </div>
        ...
        <div className="container px-4 text-center">
          ...
          <div className="mb-8 max-w-2xl mx-auto space-y-4">
            <p className="text-lg text-muted-foreground">
              Logos là dự án phần mềm miễn phí dành cho việc tra cứu và nghiên cứu Kinh Thánh. Mục tiêu của chúng tôi là cung cấp một công cụ tra cứu mã Strongs tiện lợi, trực quan và chính xác cho người dùng Việt Nam.
            </p>
            <p className="text-lg text-muted-foreground">
